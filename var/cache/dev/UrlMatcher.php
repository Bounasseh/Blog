...
return [
    ...
    [ // $staticRoutes
        ...
        '/add' => [[['_route' => 'post_add', '_controller' => 'App\\Controller\\BlogController::add'], null, null, null, false, false, null]],
        ...
        '/register' => [[['_route' => 'register_user', '_controller' => 'App\\Controller\\UsersController::register'], null, null, null, false, false, null]],
    ],
    [ // $regexpList
        0 => '{^(?'
                .'|/_(?'
    ...
    [ // $dynamicRoutes
        ...
        183 => [[['_route' => 'blog_show', '_controller' => 'App\\Controller\\BlogController::show'], ['slug'], null, null, false, true, null]],
        206 => [
            [['_route' => 'user_posts', '_controller' => 'App\\Controller\\BlogController::renderUserPosts'], ['username'], null, null, false, true, null],
